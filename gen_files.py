...
freshness = r"""/* eslint-disable react-refresh/only-export-components */
...
# ── ArticleDetail.jsx ──
article_detail = r"""import React, { useState, useEffect, useCallback } from 'react';
...
with open(os.path.join(base, 'context', 'FreshnessContext.jsx'), 'w') as f:
    f.write(freshness)
print(f"FreshnessContext.jsx: {len(freshness)} chars")

with open(os.path.join(base, 'pages', 'ArticleDetail.jsx'), 'w') as f:
    f.write(article_detail)
print(f"ArticleDetail.jsx: {len(article_detail)} chars")
