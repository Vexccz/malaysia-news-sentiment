...
import { articleToMarkdown, downloadMarkdown } from '../utils/markdownExport';
        ...
        <div className="detail-scroll-area">
          <div className="detail-content-inner">
            ...
            <div style={{ marginTop: 32 }}>
               <button onClick={() => { const md = articleToMarkdown(article); downloadMarkdown(md, (article.title || 'article').replace(/[^a-z0-9]/gi, '-').toLowerCase().slice(0, 50) + '.md'); }} className="premium-action-btn" title="Export as Markdown (Obsidian/Notion compatible)">
